...
$SqlQuery = "SELECT
                ...
                (SELECT CASE WHEN UserStaff.iBaseStaffIDid > 0 THEN BaseUserStaff.UF_2085 ELSE UserStaff.UF_2085 END FROM (SELECT iStaffID FROM ClassResource WHERE ClassResource.iClassID=Class.iClassID UNION SELECT iDefault_StaffID FROM Class as c WHERE c.iClassID=Class.iClassID) as t LEFT OUTER JOIN Staff ON t.iStaffID=Staff.iStaffID LEFT OUTER JOIN UserStaff ON Staff.iStaffID=UserStaff.iStaffID LEFT OUTER JOIN UserStaff AS BaseUserStaff ON UserStaff.iBaseStaffIDid=BaseUserStaff.iStaffID WHERE Staff.iStaffID<>0 ORDER BY Staff.iStaffID OFFSET 0 ROWS FETCH NEXT 1 ROWS ONLY) AS Teacher_id,
                (SELECT CASE WHEN UserStaff.iBaseStaffIDid > 0 THEN BaseUserStaff.UF_2085 ELSE UserStaff.UF_2085 END FROM (SELECT iStaffID FROM ClassResource WHERE ClassResource.iClassID=Class.iClassID UNION SELECT iDefault_StaffID FROM Class as c WHERE c.iClassID=Class.iClassID) as t LEFT OUTER JOIN Staff ON t.iStaffID=Staff.iStaffID LEFT OUTER JOIN UserStaff ON Staff.iStaffID=UserStaff.iStaffID LEFT OUTER JOIN UserStaff AS BaseUserStaff ON UserStaff.iBaseStaffIDid=UserStaff.iStaffID WHERE Staff.iStaffID<>0 ORDER BY Staff.iStaffID OFFSET 1 ROWS FETCH NEXT 1 ROWS ONLY) AS Teacher_2_id,
                (SELECT CASE WHEN UserStaff.iBaseStaffIDid > 0 THEN BaseUserStaff.UF_2085 ELSE UserStaff.UF_2085 END FROM (SELECT iStaffID FROM ClassResource WHERE ClassResource.iClassID=Class.iClassID UNION SELECT iDefault_StaffID FROM Class as c WHERE c.iClassID=Class.iClassID) as t LEFT OUTER JOIN Staff ON t.iStaffID=Staff.iStaffID LEFT OUTER JOIN UserStaff ON Staff.iStaffID=UserStaff.iStaffID LEFT OUTER JOIN UserStaff AS BaseUserStaff ON UserStaff.iBaseStaffIDid=UserStaff.iStaffID WHERE Staff.iStaffID<>0 ORDER BY Staff.iStaffID OFFSET 2 ROWS FETCH NEXT 1 ROWS ONLY) AS Teacher_3_id,
                (SELECT CASE WHEN UserStaff.iBaseStaffIDid > 0 THEN BaseUserStaff.UF_2085 ELSE UserStaff.UF_2085 END FROM (SELECT iStaffID FROM ClassResource WHERE ClassResource.iClassID=Class.iClassID UNION SELECT iDefault_StaffID FROM Class as c WHERE c.iClassID=Class.iClassID) as t LEFT OUTER JOIN Staff ON t.iStaffID=Staff.iStaffID LEFT OUTER JOIN UserStaff ON Staff.iStaffID=UserStaff.iStaffID LEFT OUTER JOIN UserStaff AS BaseUserStaff ON UserStaff.iBaseStaffIDid=UserStaff.iStaffID WHERE Staff.iStaffID<>0 ORDER BY Staff.iStaffID OFFSET 3 ROWS FETCH NEXT 1 ROWS ONLY) AS Teacher_4_id,
                (SELECT CASE WHEN UserStaff.iBaseStaffIDid > 0 THEN BaseUserStaff.UF_2085 ELSE UserStaff.UF_2085 END FROM (SELECT iStaffID FROM ClassResource WHERE ClassResource.iClassID=Class.iClassID UNION SELECT iDefault_StaffID FROM Class as c WHERE c.iClassID=Class.iClassID) as t LEFT OUTER JOIN Staff ON t.iStaffID=Staff.iStaffID LEFT OUTER JOIN UserStaff ON Staff.iStaffID=UserStaff.iStaffID LEFT OUTER JOIN UserStaff AS BaseUserStaff ON UserStaff.iBaseStaffIDid=UserStaff.iStaffID WHERE Staff.iStaffID<>0 ORDER BY Staff.iStaffID OFFSET 4 ROWS FETCH NEXT 1 ROWS ONLY) AS Teacher_5_id,
                (SELECT CASE WHEN UserStaff.iBaseStaffIDid > 0 THEN BaseUserStaff.UF_2085 ELSE UserStaff.UF_2085 END FROM (SELECT iStaffID FROM ClassResource WHERE ClassResource.iClassID=Class.iClassID UNION SELECT iDefault_StaffID FROM Class as c WHERE c.iClassID=Class.iClassID) as t LEFT OUTER JOIN Staff ON t.iStaffID=Staff.iStaffID LEFT OUTER JOIN UserStaff ON Staff.iStaffID=UserStaff.iStaffID LEFT OUTER JOIN UserStaff AS BaseUserStaff ON UserStaff.iBaseStaffIDid=UserStaff.iStaffID WHERE Staff.iStaffID<>0 ORDER BY Staff.iStaffID OFFSET 5 ROWS FETCH NEXT 1 ROWS ONLY) AS Teacher_6_id,
                (SELECT CASE WHEN UserStaff.iBaseStaffIDid > 0 THEN BaseUserStaff.UF_2085 ELSE UserStaff.UF_2085 END FROM (SELECT iStaffID FROM ClassResource WHERE ClassResource.iClassID=Class.iClassID UNION SELECT iDefault_StaffID FROM Class as c WHERE c.iClassID=Class.iClassID) as t LEFT OUTER JOIN Staff ON t.iStaffID=Staff.iStaffID LEFT OUTER JOIN UserStaff ON Staff.iStaffID=UserStaff.iStaffID LEFT OUTER JOIN UserStaff AS BaseUserStaff ON UserStaff.iBaseStaffIDid=UserStaff.iStaffID WHERE Staff.iStaffID<>0 ORDER BY Staff.iStaffID OFFSET 6 ROWS FETCH NEXT 1 ROWS ONLY) AS Teacher_7_id,
                (SELECT CASE WHEN UserStaff.iBaseStaffIDid > 0 THEN BaseUserStaff.UF_2085 ELSE UserStaff.UF_2085 END FROM (SELECT iStaffID FROM ClassResource WHERE ClassResource.iClassID=Class.iClassID UNION SELECT iDefault_StaffID FROM Class as c WHERE c.iClassID=Class.iClassID) as t LEFT OUTER JOIN Staff ON t.iStaffID=Staff.iStaffID LEFT OUTER JOIN UserStaff ON Staff.iStaffID=UserStaff.iStaffID LEFT OUTER JOIN UserStaff AS BaseUserStaff ON UserStaff.iBaseStaffIDid=UserStaff.iStaffID WHERE Staff.iStaffID<>0 ORDER BY Staff.iStaffID OFFSET 7 ROWS FETCH NEXT 1 ROWS ONLY) AS Teacher_8_id,
                (SELECT CASE WHEN UserStaff.iBaseStaffIDid > 0 THEN BaseUserStaff.UF_2085 ELSE UserStaff.UF_2085 END FROM (SELECT iStaffID FROM ClassResource WHERE ClassResource.iClassID=Class.iClassID UNION SELECT iDefault_StaffID FROM Class as c WHERE c.iClassID=Class.iClassID) as t LEFT OUTER JOIN Staff ON t.iStaffID=Staff.iStaffID LEFT OUTER JOIN UserStaff ON Staff.iStaffID=UserStaff.iStaffID LEFT OUTER JOIN UserStaff AS BaseUserStaff ON UserStaff.iBaseStaffIDid=UserStaff.iStaffID WHERE Staff.iStaffID<>0 ORDER BY Staff.iStaffID OFFSET 8 ROWS FETCH NEXT 1 ROWS ONLY) AS Teacher_9_id,
                (SELECT CASE WHEN UserStaff.iBaseStaffIDid > 0 THEN BaseUserStaff.UF_2085 ELSE UserStaff.UF_2085 END FROM (SELECT iStaffID FROM ClassResource WHERE ClassResource.iClassID=Class.iClassID UNION SELECT iDefault_StaffID FROM Class as c WHERE c.iClassID=Class.iClassID) as t LEFT OUTER JOIN Staff ON t.iStaffID=Staff.iStaffID LEFT OUTER JOIN UserStaff ON Staff.iStaffID=UserStaff.iStaffID LEFT OUTER JOIN UserStaff AS BaseUserStaff ON UserStaff.iBaseStaffIDid=UserStaff.iStaffID WHERE Staff.iStaffID<>0 ORDER BY Staff.iStaffID OFFSET 9 ROWS FETCH NEXT 1 ROWS ONLY) AS Teacher_10_id,
                Class.cName AS Name,
